...
{
    setAllItemsCheckedState(ui->listWidget, Qt::Checked, QColor("#ffffb2"));
    /*
...
void MainWindow::on_CreateCheckBox_triggered()
{
    TreeWidgetColumnManager dialog(ui->treeWidget, &service1, this);
    dialog.exec();
}
